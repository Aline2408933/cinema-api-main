...
export class LancheComboService {
  ...
  return this.prisma.lancheCombo.create({
    data: {
      nome: createLancheComboDto.nome,
      descricao: createLancheComboDto.descricao,
      valorUnitario: createLancheComboDto.valorUnitario,
      qtUnidade: createLancheComboDto.qtUnidade,
      subtotal: createLancheComboDto.subtotal,
      pedidoId: createLancheComboDto.pedidoId ?? null,
    },
  });
}
  findAll() {
